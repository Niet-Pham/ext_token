...
module ExtCore = {
  ...
  public type TransferResponse = Result.Result<Balance, { #Unauthorized : AccountIdentifier; #InsufficientBalance; #InsufficientAllowance; #Rejected; /* Rejected by canister */ #InvalidToken : TokenIdentifier; #CannotNotify : AccountIdentifier; #Other : Text }>;
